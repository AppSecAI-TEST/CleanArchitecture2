...
В составе данной реализации описаны следующие модули/контроллеры:
 ...
 - PreferencesModule(Singleton) - модeль работы с Application Preferences
...
Архитектура реализует слои:
 ...
 - слой модулей, обеспечивающий различный функционал приложения(в настоящее время их 23)
