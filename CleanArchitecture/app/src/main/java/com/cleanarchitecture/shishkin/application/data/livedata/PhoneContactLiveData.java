...
import com.cleanarchitecture.shishkin.api.model.ILiveData;
...
public class PhoneContactLiveData extends AbstractContentProviderLiveData<List<PhoneContactItem>> implements ILiveData<List<PhoneContactItem>> {
